...
class Settings:
    ...
    # Saved config slug (pc-...) created on the Portkey dashboard — free/starter
    # plans do not allow inline config objects, only references to saved configs.
    PORTKEY_CONFIG_SLUG = os.getenv("PORTKEY_PRIMARY_CONFIG_ID", "")
    PORTKEY_PRIMARY_SLUG = os.getenv("PORTKEY_PRIMARY_SLUG", "rag")
